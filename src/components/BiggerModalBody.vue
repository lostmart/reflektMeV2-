...
<template>
	<section class="flex items-end mt-6">
		<div class="flex items-end h-[283px] translate-x-6">
		...
		<div
			class="img-container flex justify-center items-center overflow-hidden mx-auto w-[226px] h-[282.7px]">
			<img
